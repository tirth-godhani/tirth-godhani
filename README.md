...
- **Key Features**: Embedded Shopify app with OAuth, webhooks (orders, products, refunds), GDPR compliance, and custom Shopify Functions for dynamic checkout discounts · 7 Shopify POS UI Extensions covering loyalty lookup, gift card credit conversion · 15+ automated CRON jobs for daily sales, SKU/vendor/category performance, royalty reports, and inventory audits · BullMQ job queue with real-time dashboard, Excel/CSV exports, and Slack alerts · Multi-tenant franchise management with role-based permissions, royalty configs, CNAME support, and AWS S3 asset storage
